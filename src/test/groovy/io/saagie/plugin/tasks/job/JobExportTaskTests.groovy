...
class JobExportTaskTests extends DataOpsGradleTaskSpecification {
    ...
    static final Logger logger = Logging.getLogger(JobExportTaskTests.class)
    ...
    def "projectsExportJob should export job and job version"() {
        ...
        logger.debug("results expected from testes :{}", '{"success":"true", "exportfile": "'+ tempJobDirectory.getAbsolutePath()+'/project-export-project-id.zip"}')
